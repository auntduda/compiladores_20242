...
{
       0,   144,   144,   142,   160,   163,   170,   175,   182,   187,
     195,   200,   203,   207,   211,   212,   213,   211,   217,   218,
     217,   225,   229,   233,   237,   241,   245,   249,   253,   257,
     261,   265
};
#endif
...
yysymbol_name (yysymbol_kind_t yysymbol)
{
  ...
  {
  "end of file", "error", "invalid token", "ASSGNOP", "DO", "ELSE", "END",
  "IF", "WHILE", "FI", "IN", "INTEGER", "LET", "READ", "SKIP", "THEN",
...
{
       2,   -51,    15,    -8,   -51,   -51,   -51,   -51,    24,    26,
     -24,   -51,    -6,   -51,    30,   -51,    -6,    45,    18,   -51,
     -51,   -51,   -51,    -6,    -6,    59,    -6,   -51,    59,    -6,
     -51,   -51,     5,    -6,    -6,    -6,    -6,    -6,    -6,    -6,
      35,    59,    59,   -51,    64,    64,    11,    11,    27,    27,
      27,   -51,    55,    60,   -51,    56,    38,   -51,   -51,   -51,
      49,   -51
};
...
{
       0,     4,     0,     0,     1,     2,     6,     8,     0,     0,
       0,     3,     0,    18,     0,    10,     0,     0,     0,     5,
       7,    22,    21,     0,     0,    14,     0,    11,    12,     0,
...
{
      28,    53,     5,     6,    56,    19,    20,    31,    32,    60,
      41,    21,    22,    42,     1,     4,    23,    44,    45,    46,
      47,    48,    49,    50,    33,    34,    24,    35,    36,    37,
      38,    39,    11,    12,    13,    37,    38,    39,    43,    14,
      15,    10,    16,    17,    58,    12,    13,    27,    29,    30,
      51,    14,    15,    39,    16,    17,    12,    13,    61,    54,
       0,    57,    14,    15,     0,    16,    17,    12,    13,     0,
       0,     0,     0,    14,    15,     0,    16,    17,    33,    34,
       0,    35,    36,    37,    38,    39,    35,    36,    37,    38,
      39
};

static const yytype_int8 yycheck[] =
{
      16,    51,    10,    11,    54,    29,    30,    23,    24,    59,
      26,    17,    18,    29,    12,     0,    22,    33,    34,    35,
      36,    37,    38,    39,    19,    20,    32,    22,    23,    24,
      25,    26,     6,     7,     8,    24,    25,    26,    33,    13,
      14,    17,    16,    17,     6,     7,     8,    17,     3,    31,
      15,    13,    14,    26,    16,    17,     7,     8,     9,     4,
      -1,     5,    13,    14,    -1,    16,    17,     7,     8,    -1,
      -1,    -1,    -1,    13,    14,    -1,    16,    17,    19,    20,
...
{
       0,    12,    35,    37,     0,    10,    11,    36,    38,    39,
      17,     6,     7,     8,    13,    14,    16,    17,    40,    29,
      30,    17,    18,    22,    32,    46,    44,    17,    46,     3,
      31,    46,    46,    19,    20,    22,    23,    24,    25,    26,
      41,    46,    46,    33,    46,    46,    46,    46,    46,    46,
      46,    15,    45,    39,     4,    42,    39,     5,     6,    43,
      39,     9
};
...
#line 200 "sintatico.y"
                      {
        context_check( READ_INT, (yyvsp[0].id) ); /* Verifica se IDENTIFIER esta na tabela de simbolos e marca como usado. */
    }
...
#line 211 "sintatico.y"
                                    {(yyvsp[-1].lbls) = (struct lbs *) create_label(); (yyvsp[-1].lbls)->for_jmp_false = reserve_loc();}
...
#line 213 "sintatico.y"
                                    {back_patch((yyvsp[-6].lbls)->for_jmp_false, JMP_FALSE, (struct stack_t) {.intval = gen_label()});}
#line 1590 "sintatico.tab.c"
    break;

  case 17: /* command: IF exp $@2 THEN commands $@3 ELSE $@4 commands FI  */
#line 215 "sintatico.y"
                                    {back_patch((yyvsp[-9].lbls)->for_goto, GOTO, (struct stack_t) {.intval = gen_label()});}
#line 1596 "sintatico.tab.c"
    break;

  case 18: /* $@5: %empty  */
#line 217 "sintatico.y"
                                    {(yyvsp[0].lbls) = (lbs *) create_label(); (yyvsp[0].lbls)->for_goto = gen_label();}
...
#line 221 "sintatico.y"
                                    {gen_code(GOTO, (struct stack_t) {.intval = (yyvsp[-6].lbls)->for_goto}); 
                                            back_patch((yyvsp[-6].lbls)->for_jmp_false, JMP_FALSE, (struct stack_t) {.intval = gen_label()});}
...
#line 229 "sintatico.y"
                 {
        context_check(LD_VAR, (yyvsp[0].id)); /* Verifica se IDENTIFIER esta na tabela de simbolos e se teve atribuicao. */
