...
{
       0,   131,   131,   129,   147,   150,   157,   162,   169,   174,
     182,   187,   190,   194,   198,   199,   200,   198,   204,   205,
     204,   212,   216,   220,   224,   228,   232,   236,   240,   244,
     248,   252
};
#endif
...
#line 131 "sintatico.y"
                            {gen_code(DATA, (struct stack_t) {.intval = symTab->offset});}
...
#line 198 "sintatico.y"
                                    {lbs* x; x = create_label(); x->for_jmp_false = reserve_loc();}
...
#line 204 "sintatico.y"
                                    {(yyvsp[0].int) = (lbs *) create_label(); (yyvsp[0].int)->for_goto = gen_label();}
